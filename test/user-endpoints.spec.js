      ...
      it('inserts 1 language with words for the new user', () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'oro', translation: 'gold' },
            { original: 'cohete', translation: 'rocket' },
            { original: 'tormenta', translation: 'storm' },
            { original: 'libro', translation: 'book' },
            { original: 'cueva', translation: 'cave' },
            { original: 'arena', translation: 'sand' },
            { original: 'granja', translation: 'farm' },
          ],
        };
        return supertest(app)
          .post('/api/user')
